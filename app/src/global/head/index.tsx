...
const appTitle = "Lennert Van Geert";
const defaultKeyWords =
  "Lennert Van Geert, Portfolio, Web Developer, Frontend Developer, Backend Developer, Full Stack Developer, React, Node.js, JavaScript, TypeScript, Web Development";
